...
avg_values = [sum(i) / len(i) for i in grades]
#round_avg_values =  [round(x,2) for x in avg_values]
#avg_ball = dict(zip(sort_students, round_avg_values))
avg_ball = dict(zip(sort_students, avg_values))
print(avg_ball)
