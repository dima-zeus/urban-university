...
# Решение задачи «Словари и множества»
my_dict = {'Dima': 1980, 'Andrey': 1985, 'Misha': 1975}
print(my_dict)
print(my_dict['Andrey'])
print(my_dict.get('b'))
my_dict.update({'Anton': 1986, 'Sergey': 1983})
print(my_dict)
del_element = my_dict.pop('Misha')
print(del_element)
print(my_dict)

my_set = {1, 2, 2, 1, 3, 4, 5, 5, 6, 'seven', 'seven', True}
print(my_set)
my_set.update([8, '8'])
print(my_set)
my_set.remove(2)
